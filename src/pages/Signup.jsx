...
import { Loader2, ArrowRight, User, Mail, Lock, UserPlus } from "lucide-react";
...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden font-sans text-slate-300">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-[#020617]/60 backdrop-blur-[30px]" />
            ...
            >
                ...
                <div className="text-center mb-8 mt-2">
                    ...
                    <p className="text-sm font-medium text-[#94a3b8]">
                        Sign up to start tracking your interview progress.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-black/20 border border-white/[0.05] focus:border-indigo-500/50 focus:bg-black/40 outline-none transition-all text-white placeholder:text-slate-500 font-medium"
                        />
                    </div>
                    ...
                    <motion.button
                        whileHover={{ scale: 1.01, boxShadow: "0 0 20px rgba(79,70,229,0.3)" }}
                        whileTap={{ scale: 0.98 }}
                        type="submit"
                        disabled={loading}
                ...
                <div className="mt-6 flex flex-col items-center gap-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full py-3.5 rounded-xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.08] transition-colors flex items-center justify-center gap-3 text-white font-bold hover:text-slate-200"
                    >
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full py-3 rounded-xl bg-transparent hover:bg-white/[0.02] transition flex items-center justify-center gap-2 text-white hover:text-slate-200 text-sm font-semibold mt-2"
                    >
